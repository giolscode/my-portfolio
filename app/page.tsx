      ...
      {/* Projet */}
        ...
        >
          ...
          <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 md:gap-6 lg:gap-8 mt-6 justify-items-center">
            ...
            <CardProject title="Buddies" imageSrc="/buddies.jpeg"  description="Une application mobile rescencant les évènements musicaux et permettant de communiquer des utilisateurs ." linkUrl={"https://github.com/CorentinDeldalle19/buddies"} technos={["flutter","nodejs"]}/>
